...
export const PLACES_PENINSULA: Place[] = [
  {
    ...
    camera: {
      hero: { lon: 18.3476, lat: -34.0479, zoom: 14.6, pitch: 63, bearing: 215 },
      context: { lon: 18.335, lat: -34.04, zoom: 11.7, pitch: 48, bearing: 190 },
      close: { lon: 18.3476, lat: -34.0479, zoom: 16, pitch: 67, bearing: 250 },
    },
  ...
  },
  {
    ...
    camera: {
      hero: { lon: 18.3625, lat: -34.0895, zoom: 15.2, pitch: 64, bearing: 190 },
      context: { lon: 18.36, lat: -34.07, zoom: 11.6, pitch: 47, bearing: 170 },
      close: { lon: 18.3625, lat: -34.0895, zoom: 16, pitch: 68, bearing: 255 },
    },
  ...
  },
  {
    ...
    camera: {
      hero: { lon: 18.471, lat: -34.1073, zoom: 15, pitch: 60, bearing: 190 },
      context: { lon: 18.465, lat: -34.1, zoom: 12.2, pitch: 50, bearing: 155 },
      close: { lon: 18.471, lat: -34.1073, zoom: 16.2, pitch: 66, bearing: 235 },
    },
  ...
  },
  {
    ...
    camera: {
      hero: { lon: 18.4524, lat: -34.1981, zoom: 15, pitch: 62, bearing: 175 },
      context: { lon: 18.44, lat: -34.2, zoom: 12, pitch: 52, bearing: 160 },
      close: { lon: 18.4524, lat: -34.1981, zoom: 16.4, pitch: 67, bearing: 230 },
    },
  ...
  },
  {
    ...
    camera: {
      hero: { lon: 18.4333, lat: -34.1932, zoom: 15.3, pitch: 62, bearing: 135 },
      context: { lon: 18.43, lat: -34.195, zoom: 12.4, pitch: 50, bearing: 120 },
      close: { lon: 18.4333, lat: -34.1932, zoom: 16.3, pitch: 66, bearing: 210 },
    },
  ...
  },
  {
    ...
    camera: {
      hero: { lon: 18.4978, lat: -34.3574, zoom: 14.6, pitch: 60, bearing: 165 },
      context: { lon: 18.46, lat: -34.32, zoom: 11.3, pitch: 46, bearing: 150 },
      close: { lon: 18.4978, lat: -34.3574, zoom: 16.2, pitch: 67, bearing: 195 },
    },
